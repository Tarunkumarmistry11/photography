...
const About = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-zinc-900">
      <div
        ref={AboutOneRef}
        className="fixed top-[20vh] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-full z-10"
      >
        <h1 className="text-9xl font-bold font-['Founders_Grotesk']">Tarun</h1>
      </div>
      <div
        ref={AboutRef}
        className="fixed top-[40vh] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-full"
      >
      ...
      <div className="w-full py-[50vh] flex justify-center items-center">
        <div className="w-full h-full flex justify-center items-center">
          <video
            ref={videoRef}
            className="rounded-3xl max-w-8xl w-[30vw] h-auto"
            controls
            loop
            autoPlay
            muted
      ...
      <div className="section-title about-wrapper py-20">
        <div
          ref={textRef}
          className="page-paragraph text-wrap px-[30vw] text-2xl font-['Founders_Grotesk']"
        >
          <h1>
            The symphony of nature, the earthy scent of grass, the whispering
            breeze carrying stories of old trees and fallen leaves, and above
            all, the lingering aroma of pure joy, forever etched in my heart.
            Growing up on the serene island of Andaman and Nicobar, I nurtured a
            deep, playful bond with nature..
          </h1>
        </div>
      </div>
      <div>
