...
const HorizontalSlider = () => {
  return (
    <div className="relative w-full h-screen py-20 overflow-hidden transform -rotate-2">
      <div className="flex">
          ...
          <div className="flex space-x-4 overflow-x-auto scrollbar-hide">
            ...
            <div className="flex-none">
              <img
                ...
                alt="Photo 1"
                className="w-64 h-auto rounded-3xl sm:w-72 md:w-80 lg:w-96 xl:w-108"
              />
            </div>
            <div className="flex-none">
              <img
            ...
            <div className="flex-none">
              <img
                src="https://assets-global.website-files.com/60db5e59f76ae577e9f50d42/61f7f6a3627fccd34acd48ef_photo-creative-2.jpg"
                alt="Photo 6"
                className="w-64 rounded-3xl h-auto sm:w-72 md:w-80 lg:w-96 xl:w-108"
              />
            </div>
            <div className="flex-none">
              <img
